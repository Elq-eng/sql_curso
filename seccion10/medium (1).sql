...
CREATE TABLE "user_lists" (
  "user_lists_id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "user_id" integer,
  "title" varchar(100)
);
...
ALTER TABLE "posts" ADD FOREIGN KEY ("create_by") REFERENCES "users" ("user_id");
...
ALTER TABLE "user_list_entry" ADD FOREIGN KEY ("user_list_id") REFERENCES "user_lists" ("user_lists_id");
